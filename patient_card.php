<div class="add-form">
    <div class="card-form card-form_columns">
        ...
        <div class="card-form_row">
            ...
            <div class="card-form_text">Иван Иванов</div>
        </div>
        <div class="card-form_row">
            ...
            <div class="card-form_row">
                ...
                <div class="card-form_text">24.12.1996</div>
            </div>
            <div class="card-form_row">
                <div class="card-form_header">Группа крови:</div>
                <div class="card-form_text">B+</div>
            </div>
            <div class="card-form_row">
                <div class="card-form_header">Номер телефона:</div>
                <div class="card-form_text">+1-002-453-12-56</div>
            </div>
            <div class="card-form_row">
                <div class="card-form_header">Адресс:</div>
                <div class="card-form_text">г. Минск, улица Октябрськая, дом 77</div>
            </div>
            <div class="card-form_row">
                <div class="card-form_header">Статус пациента:</div>
                <div class="card-form_text">Трудоустроенный</div>
            </div>
    </div>
</div>